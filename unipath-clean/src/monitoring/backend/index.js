...
export class MonitoringSystem {
    ...
    constructor(options = {}) {
        ...
        this.bridge = new MonitoringBridge(this.prisma, options.projectRoot || this.projectManager.getProjectRoot());
    }
    /**
...
╚════════════════════════════════════════════════════════╝
     ...
     */
    attachToAgent(orchestrator, memoryManager) {
        if (orchestrator) {
 ...
 */
export function integrateWithAgent(orchestrator, memoryManager, options) {
