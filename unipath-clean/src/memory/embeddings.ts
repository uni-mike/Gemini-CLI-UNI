...
export class EmbeddingsManager {
  ...
  constructor() {
    ...
    this.client = new OpenAI({
      ...
      baseURL: `${process.env.EMBEDDING_API_ENDPOINT}openai/deployments/${process.env.EMBEDDING_API_DEPLOYMENT}`,
    ...
    this.deployment = process.env.EMBEDDING_API_DEPLOYMENT || 'text-embedding-3-large';
  }
