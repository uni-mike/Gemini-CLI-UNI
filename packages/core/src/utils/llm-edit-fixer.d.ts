 ...
 */
export declare function FixLLMEditWithInstruction(instruction: string, old_string: string, new_string: string, error: string, current_content: string, unipathClient: UnipathClient, abortSignal: AbortSignal): Promise<SearchReplaceEdit>;
