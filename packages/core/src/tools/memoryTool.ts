...
let currentUnipathMdFilename: string | string[] = DEFAULT_CONTEXT_FILENAME;

export function setUnipathMdFilename(newFilename: string | string[]): void {
...
export function getCurrentUnipathMdFilename(): string {
...
export function getAllUnipathMdFilenames(): string[] {
  if (Array.isArray(currentUnipathMdFilename)) {
    return currentUnipathMdFilename;
  }
  return [currentUnipathMdFilename];
