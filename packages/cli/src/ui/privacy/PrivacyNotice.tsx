...
import { Box } from 'ink';
import { type Config, AuthType } from '@unipath/unipath-cli-core';
...
const PrivacyNoticeText = ({
  ...
  switch (authType) {
    ...
    case AuthType.AZURE_OPENAI:
      return <GeminiPrivacyNotice onExit={onExit} />; // Use same privacy notice for now
